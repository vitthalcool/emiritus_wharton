...
<head>
	...
	<link rel="stylesheet" type="text/css" href="https://execed-emeritus.wharton.upenn.edu/business-analytics/css/responsive_new.css?v=0.0.1">
	...
	<div class="wrapper">
			...
			<div class="banner-bg">
				<div class="container df">
					...
					<div id="2" class="col-md-5 form-div no_pad">
							<form class="form-horizontal contact-form" role="form" id="frm" name="frm" method="POST" action="https://execed-emeritus.wharton.upenn.edu/test/business-analytics/submit.php">
			...
			<div class="col-md-4 col-sm-4 no_pad">
				<div class="info-box clearfix">
					...
					<div class="img-content">
						...
						<p>$2,450</p>
						<h6 class="info">
							<a href="javascript:void(0)" onclick="trackEvent('click','BA LP','Pop Up','Flexi Pay')" data-toggle="modal" data-target="#myModal"> <img src="https://execed-emeritus.wharton.upenn.edu/business-analytics/images/info_icon.png" alt="info" title="info" class="">&nbsp;<i class="bm">Flexible payment available</i></a>
						</h6>
					</div>
				</div>
			</div>
		...
		<div class="top-footer">
			<div class="text-center">
				<a href="https://emeritus-admissions.secure.force.com/StudentPrograms?pid=01t0I000004lceN" onclick="trackEvent('click','BA LP','Redirect','Apply Now')" target="_blank"><button class="btn btn-default apply-btn">Apply Now</button></a>
