...
require_once '../entrepreneurship/xss_clean.php';
...
$workexp		=isset($_POST['workexp'])? $xssClean->clean_input(trim(strip_tags($_POST['workexp']))):'';
...
<input type="hidden" name="retURL" value="https://execed-emeritus.wharton.upenn.edu/test/<?php echo strip_tags($thankyoupage);?>">						
<input type="hidden" name="lead_source" value="<?php echo strip_tags($lead_source);?>">	
