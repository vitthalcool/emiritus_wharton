...
<head>
	...
	<link rel="shortcut icon" href="https://www.emeritus.org/favicon.ico" type="image/x-icon">
	<link rel="icon" href="https://www.emeritus.org/favicon.ico" type="image/x-icon">
	<meta name="description" content="BUSINESS ANALYTICS: FROM DATA TO INSIGHTS"/>
	<link rel="stylesheet" type="text/css" href="https://execed-emeritus.wharton.upenn.edu/business-analytics/css/style_new.css">
	<link rel="stylesheet" type="text/css" href="https://execed-emeritus.wharton.upenn.edu/business-analytics/css/responsive_new.css">
...
<!-- End Google Tag Manager -->
		...
		<script>
		function trackEvent(event, category, action, label, interaction) {
            ga('send', 'event', category, action, label,{nonInteraction: interaction});
	...
	<div class="wrapper">
		<div class="container-fluid" id="header">
			<div class="container">
				<header class="header">
					<div class="row">
					  <div class="col-sm-6">
						 <a href="https://emeritus.org/" target="_blank" onclick="trackEvent('click','BA LP','Redirect','Partner Logo',true)"><img src="https://execed-emeritus.wharton.upenn.edu/business-analytics/images/logo.png" alt="wharton" title="wharton" class="img-responsive"> </a>
					  </div>
					...
					<div id="2" class="col-md-5 form-div no_pad">
							<form class="form-horizontal contact-form" role="form" id="frm" name="frm" method="POST" action="submit.php">
								...
								<div id="fields">
									...
									<div class="form-group">
										<div class="col-sm-12">
											<input type="submit" onclick="trackEvent('click','BA LP','FormSubmit','Form_Submit',true)" class="btn btn-default download-btn" value="DOWNLOAD BROCHURE >"/>
										</div>
									</div>
									<div class="form-group">
										<div class="col-sm-12">
		...
		<div class="container padtop">
				...
				<div class="row counter-row">
					...
					<div class="marb92 mb92">
						<a href="#2" onclick="trackEvent('click','BA LP','ScrollUp','Download Brochure',false)"><button class="btn btn-default download-btn"> DOWNLOAD BROCHURE</button></a>
					</div>
				</div>
		...
		<!--  <div class="video-wrapper youtubevideo">
				...
				<div class="bg_grey">
					<div class="content-wrapper">
						...
						<a href="#2" onclick="trackEvent('click','BA LP','ScrollUp','Download Syllabus',false)" target="_blank"><button class="btn btn-default download-btn">DOWNLOAD SYLLABUS</button></a>
				</div>
			...
			<div class="container">
				...
				<div class="row p-50 container-row">
					...
					<div class="col-md-12 col-sm-12 col-xs-12 text-right">
						<a href="" onclick="trackEvent('click','BA LP','Load More','Load More',false)" class="load_more" id="loadMore">Load More</a>
					</div>
				</div>
			</div>	
		...
		<div class="top-footer">
			<div class="text-center">
				<a href="#" onclick="trackEvent('click','BA LP','ScrollUp','Apply Now',false)" target="_blank"><button class="btn btn-default apply-btn">Apply Now</button></a>
				<h3>Early applications are encouraged. Seats fill up quickly!</h3>
				<h5>Flexible Payment options available. <a href="#" onclick="trackEvent('click','BA LP','Pop Up','Flexi Pay',true)" class="applynow" data-toggle="modal" data-target="#myModal">Click here</a> to know more.</h5>
			</div>
		</div>
            ...
            <div class="clearfix content_p">
              <h5>The following payment options are available for the <i>Business Analytics</i> program:</h5>
				...
				<ul class="ul_style">Pay in 2 installments</ul>
					<li>The first installment of <b>$1,399</b> would be <b>due immediately.</b>
					</li>
					<li>The second installment of <b>$1,100</b> will be charged on <b>April 28, 2018.</b>
					</li>
				</ul>

				<ul class="ul_style">Pay in 3 installments</ul>
					<li>The first installment of <b>$926</b> would be <b>due immediately.</b>
					</li>
					<li>The second installment of <b>$823</b> will be charged on <b>April 28, 2018.</b>
					</li>
					<li>The third installment of <b>$823</b> will be charged on <b>May 18, 2018</b>
					</li>
				</ul>
            </div>
          </div>
...
<script src="https://execed-emeritus.wharton.upenn.edu/business-analytics/js/countries-new.js?v=0.0.1"></script>
