					...
					<div id="2" class="col-md-5 form-div no_pad">
							<form class="contact-form">
								<div class="text-center thakyou-outer">
									<p class="thankyou">It's not too late to join 7500+ students from 120+ countries who have already taken our programs.</p>
									<p class="getintouch">Application Deadline: July 18, 2018<br/>Program Starts: July 19, 2018</p>
									<div class="text-center">
									<p style="padding:2% 0;"><a style="display: block; margin: 0 auto;width: 144px;text-decoration:none ! important;border-color:#b8434f;" class="btn btn-default download-btn-link" href="http://bit.ly/2uHVyPb" target="_blank"> APPLY NOW</a></p>
									</div>
								</div>	
							</form>
					</div>
