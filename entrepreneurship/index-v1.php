...
<head>
	...
	<link rel="stylesheet" type="text/css" href="assets/css/style_new-2.css">
	<link rel="stylesheet" type="text/css" href="assets/css/responsive_new-2.css?v=0.0.1">
...
<body>
	<div class="wrapper">
		<div class="container-fluid">
			<div class="container">
				<header class="header">
					<div class="row">
					  <div class="col-sm-6">
						 <a href="https://execed-emeritus.wharton.upenn.edu/entrepreneurship/index-v1.php" target="_blank" onclick="trackEvent('click','EAP LP','Reload','Partner Logo')"><img src="assets/images/logo-new.png" alt="wharton" title="wharton" class="img-responsive"> </a>
					  </div>
					</div>
				</header>
			</div>	
		</div>
		<div class="header-topic" id="header">
			<div class="container no-padd">
				<div class="col-md-7 col-sm-7">
					<h1 class="main-title">
						Entrepreneurship Acceleration Program: <br class="mobile-show">
						Scaling Your Business
					</h1>
				</div>
				<div class="col-md-5 col-sm-5">	
					<h3 class="online-certi">ONLINE CERTIFICATE PROGRAM</h3>
				</div>
			</div>	
		</div>
		<div class="container df vedio-section">
			...
			<div id="2" class="col-md-5 col-sm-6 col-xs-12 banner-item section-form">
				<form class="form-horizontal registerform" role="form" id="frm" name="frm" method="POST" action="submit.php" >
								<p class="request">GET PROGRAM INFO</p>
								<?php
		...
		<div class="container text-center">
				<p class="funding">Seed funding of <span>$25,000 for the winner</span> and <span>$10,000 for the runner-up</span> in the pitch competition!</p>
		...
		<div class="container padtop">
			...
			<div class="container program-topic">
			...
			<div class="bg_grey mobile-section">	
