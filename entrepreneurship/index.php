		...
		<div class="container-fluid" id="header">
			<div class="container">
				<header class="header">
					<div class="row">
					  <div class="col-sm-6">
						 <a href="https://execed-emeritus.wharton.upenn.edu/entrepreneurship/index.php" target="_blank" onclick="trackEvent('click','EAP LP','Reload','Partner Logo')"><img src="assets/images/logo.png" alt="wharton" title="wharton" class="img-responsive"> </a>
					  </div>
