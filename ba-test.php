...
<head>
	...
	<script>
	  ...
	  ga('create', 'UA-71668354-1', 'auto', {'allowLinker': true});
		ga('require', 'linker');
		ga('linker:autoLink', ['www.emeritus.org','www2.emeritus.org','eim.mit.edu','emeritus.gsb.columbia.edu'] );
	  ga('send', 'pageview');
	</script>
		...
		<div class="container-fluid" id="header">
			<div class="container">
				<header class="header">
					<div class="row">
					  <div class="col-sm-6">
						 <a href="https://execed-emeritus.wharton.upenn.edu/" target="_blank" onclick="trackEvent('click','BA LP','Redirect','Partner Logo')"><img src="https://execed-emeritus.wharton.upenn.edu/business-analytics/images/logo.png" alt="wharton" title="wharton" class="img-responsive"> </a>
					  </div>
			...
			<div class="banner-bg">
				<div class="container df">
					...
					<div id="2" class="col-md-5 form-div no_pad">
							<form class="form-horizontal contact-form" role="form" id="frm" name="frm" method="POST" action="https://execed-emeritus.wharton.upenn.edu/submit-test.php">
								...
								<div id="fields">
									...
									<div class="form-group">
										<label class="control-label col-xs-4 col-sm-3 col-md-4">Work Experience (in the last year)*</label>
										<div class="col-xs-8 col-sm-9 col-md-8">
            ...
            <div class="clearfix content_p">
              <h5>The following payment options are available for the <i>Business Analytics</i> program:</h5>
				...
				<ul class="ul_style">Pay in 2 installments</ul>
					<li>The first installment of <b>$1,349</b> would be <b>due immediately.</b>
					</li>
					<li>The second installment of <b>$1,150</b> will be charged on <b>June 15, 2018.</b>
					</li>
				</ul>

				<ul class="ul_style">Pay in 3 installments</ul>
					<li>The first installment of <b>$1,029</b> would be <b>due immediately.</b>
					</li>
					<li>The second installment of <b>$772</b> will be charged on <b>June 15, 2018.</b>
					</li>
					<li>The third installment of <b>$772</b> will be charged on <b>July 06, 2018.</b>
					</li>
				</ul>
            </div>
          </div>
